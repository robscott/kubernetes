...
func TestPrintIngress(t *testing.T) {
	ingress := networking.Ingress{
		...
		Spec: networking.IngressSpec{
			Class: utilpointer.StringPtr("foo"),
	...
	testCases := []struct {
		...
		ingressClass: &networking.IngressClass{
			...
			Spec: networking.IngressClassSpec{
				...
				Parameters: &api.TypedLocalObjectReference{Kind: "CustomParams", Name: "example"},
			},
		},
		expected: []metav1.TableRow{{Cells: []interface{}{"test1", "example.com/controller", "CustomParams/example", "10y"}}},
	}, {
