...
func AddHandlers(h printers.PrintHandler) {
	...
	endpointSliceColumnDefinitions := []metav1beta1.TableColumnDefinition{
		...
		{Name: "TargetType", Type: "string", Description: discoveryv1alpha1.EndpointSlice{}.SwaggerDoc()["targetType"]},
...
func printEndpointSlice(obj *discovery.EndpointSlice, options printers.PrintOptions) ([]metav1beta1.TableRow, error) {
	row := metav1beta1.TableRow{
		Object: runtime.RawExtension{Object: obj},
	}
	row.Cells = append(row.Cells, obj.Name, obj.Ports, obj.TargetType, obj.Endpoints)
	return []metav1beta1.TableRow{row}, nil
}

func printEndpointSliceList(list *discovery.EndpointSliceList, options printers.PrintOptions) ([]metav1beta1.TableRow, error) {
	rows := make([]metav1beta1.TableRow, 0, len(list.Items))
	for i := range list.Items {
